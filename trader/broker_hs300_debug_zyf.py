...
def update_stock_data_table(results: dict,
                            current_date: str,
                            db_path: str = '/home/export/base/ycsc_wangbenyou/yangyz/online1/toby/Graph-Agent-Network/data/UserDB/sys_100_hs300.db',
                            real_data_path: str = '/home/export/base/ycsc_wangbenyou/yangyz/online1/toby/Graph-Agent-Network/data/UserDB/stock_data_hs300.csv',
                            output_dir: str = 'simulation_results',
                            df_stock: pd.DataFrame = None):
    """
    更新数据库中的 StockData 表。
    ...
    Args:
        ...
        db_path (str): 数据库文件路径，默认为 'sys_100_hs300.db'。
